...
const Footer = ({ locale }) => {
  ...
  return (
    <div className="relative border-base-border text-base-light border-t w-full flex flex-col gap-5 p-5">
      {/* محتوى الأعمدة الأساسي */}
      ...
      <div className="absolute bottom-0 right-0 w-90 h-90 lg:h-full pointer-events-none z-0">
